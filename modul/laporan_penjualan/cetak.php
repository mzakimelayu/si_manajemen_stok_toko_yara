            ...
            <tbody>
                ...
                if(isset($_GET['tipe_filter'])) {
                    ...
                    $query = "SELECT 
                            ...
                            pl.no_hp_pelanggan,
                            pl.alamat_pelanggan,
                            pn.nama_lengkap_pengguna as nama_kasir,
                            b.nama_barang,
                            b.kode_barang,
                            pd.qty,
                            pd.harga_satuan,
                            pd.harga_modal,
                            pd.subtotal,
                            (pd.qty * pd.harga_modal) as total_modal,
                            (pd.subtotal - (pd.qty * pd.harga_modal)) as keuntungan
                            FROM penjualan p
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        while($row = mysqli_fetch_assoc($result)) {
                            ...
                            echo "<td>".$row['no_hp_pelanggan']."</td>";
                            ...
                            echo "<td>Rp ".number_format($row['harga_modal'],0,',','.')."</td>";
                            ...
                            echo "<td>Rp ".number_format(($row['subtotal'] * $row['diskon'] / 100),0,',','.')."</td>";
