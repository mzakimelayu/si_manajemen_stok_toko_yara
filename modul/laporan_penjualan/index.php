        ...
        <div class="bg-white rounded-lg shadow p-4 sm:p-6">
            ...
            <form action="" method="GET" class="space-y-6 mb-8">
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <!-- Customer Filter -->
                    <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow duration-300">
                        <h3 class="text-lg font-semibold text-gray-800 mb-4">Filter Pelanggan</h3>
                        <div class="relative">
                            <select name="pelanggan" id="pelanggan" class="w-full px-4 py-2.5 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200">
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        if(isset($_GET['filter'])) {
                            ...
                            $query = "SELECT p.tanggal, p.status_dihapus, p.no_faktur_penjualan, p.total_harga, 
                                    pl.nama_pelanggan, pg.nama_lengkap_pengguna,
                                    b.nama_barang, pd.qty, pd.harga_satuan, pd.subtotal
                                    FROM penjualan p
                            ...
                            if (mysqli_num_rows($result) > 0) {
                                while($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    echo "<td class='px-4 py-3 text-sm text-gray-700'>".$row['nama_lengkap_pengguna']."</td>";
                                ...
                                echo "<tr><td colspan='10' class='px-4 py-3 text-sm text-gray-700 text-center'>Tidak ada data</td></tr>";
                            }
                        } else {
                            echo "<tr><td colspan='10' class='px-4 py-3 text-sm text-gray-700 text-center'>Silahkan pilih filter terlebih dahulu</td></tr>";
                        }
                        ?>
                    </tbody>
                </table>
