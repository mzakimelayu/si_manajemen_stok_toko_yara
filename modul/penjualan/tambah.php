...
<?php include '../../layout/sidebar.php'; ?>
    ...
    <main class="flex-1 p-4 sm:p-6 animate-fade-in">
        <div class="bg-white rounded-xl shadow-lg p-6 sm:p-8">
            <h2 class="text-2xl font-bold text-gray-800 mb-8 border-b pb-4">Transaksi Penjualan Barang</h2>
                        ...
                        <div class="flex flex-col sm:flex-row gap-4 sm:gap-6">
                            <div class="w-full sm:flex-1">
                                ...
                                <?php
                                    ...
                                    $no_faktur = "YRB-" . $year . $month . $day . $time . $random;
                                ?>
                                <input type="text" id="noFaktur" name="no_faktur_penjualan" value="<?php echo $no_faktur; ?>" class="mt-1 block w-full rounded-lg border border-gray-300 bg-white px-3 sm:px-4 py-2 focus:border-blue-500 focus:ring-2 focus:ring-blue-200" readonly required>                            
                            </div>
                            
                            <div class="w-full sm:flex-1">
                                <label class="block text-sm font-semibold text-gray-700 mb-2">Tanggal Penjualan <span class="text-red-500">*</span></label>
                                <input type="date" id="tanggalPenjualan" name="tanggal" value="<?php echo date('Y-m-d', time()); ?>" class="mt-1 block w-full rounded-lg border border-gray-300 bg-white px-3 sm:px-4 py-2 focus:border-blue-500 focus:ring-2 focus:ring-blue-200" required>                            
                            </div>
                        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div class="bg-gray-50 p-6 rounded-lg space-y-4 border border-gray-300">
                        ...
                        <div class="flex items-center gap-4 bg-white p-4 rounded-lg border border-gray-300">
                            ...
                            <input type="number" id="dibayar" name="dibayar" min="0" step="0.01" class="w-full rounded-lg border border-gray-300 px-3 py-2 focus:border-blue-500 focus:ring-2 focus:ring-blue-200" value="0" required>
                        </div>
                ...
                row.innerHTML = `
                    <td class="px-4 py-3" style="min-width: 300px;">
                        <div class="relative">
                            ...
                            <input type="hidden" name="barang[${barangCounter}][harga_modal]" class="harga-modal">
